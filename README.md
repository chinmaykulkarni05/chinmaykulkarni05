...
`Classification` · `Linear & Logistic Regression` · `KNN` · `Decision Trees` · `Random Forest` · `Gradient Boosting` · `Time Series Forecasting`
...
`ANN` · `RNN` · `LSTM` · `GAN` · `Attention Mechanism` · `Transformers`
...
`RAG` · `LoRA Fine-Tuning` · `PEFT` · `Vector Databases` · `Prompt Engineering` · `ChromaDB`
...
| **Best Accuracy** | 93% (Random Forest) |
| **Key Techniques** | EDA, Feature Engineering, R² Evaluation |
| **Deployment** | Flask + HTML/CSS/Bootstrap/JS Web App |
